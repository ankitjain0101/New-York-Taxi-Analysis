...
#define spark home directories
Sys.setenv(JAVA_HOME = "/Library/Java/JavaVirtualMachines/jdk1.8.0_211.jdk/Contents/Home")
Sys.setenv(SPARK_HOME = "/usr/local/Cellar/apache-spark/2.4.3/libexec/")
...
#connect to spark and start the spark session
sparkR.session(master = "local[*]", sparkConfig = list(spark.driver.memory = "2g"))

y=read.csv('E:/College/Analytics/Big Data/train.csv')
str(train)
# 1. EDA
#Load data
train <- as.tibble(fread('E:/College/Analytics/Big Data/train.csv'))
...
train_kaggle = fread("E:/College/Analytics/Big Data/train.csv", verbose = F, showProgress = F)
...
set.seed(0)
train <- fread("E:/College/Analytics/Big Data/train.csv", showProgress = FALSE)
...
#PICKUPS
p <- densityCalc(train$pickup_datetime)
heat_ly(p, title = "Pickup Demand")
#DROPOFFS
